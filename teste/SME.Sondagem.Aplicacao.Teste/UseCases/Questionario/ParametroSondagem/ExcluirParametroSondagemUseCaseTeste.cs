...
{
    public class ExcluirParametroSondagemUseCaseTeste
    {
        private readonly Mock<IRepositorioParametroSondagem> repositorioMock;
        private readonly ExcluirParametroSondagemUseCase useCase;

        public ExcluirParametroSondagemUseCaseTeste()
        {
            repositorioMock = new Mock<IRepositorioParametroSondagem>();
            useCase = new ExcluirParametroSondagemUseCase(repositorioMock.Object);
        }
        ...
        public async Task Deve_retornar_false_quando_remocao_logica_nao_afetar_registro()
        {
            ...
            repositorioMock
                .Setup(r => r.ObterPorIdAsync(It.IsAny<long>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new Dominio.Entidades.ParametroSondagem());
