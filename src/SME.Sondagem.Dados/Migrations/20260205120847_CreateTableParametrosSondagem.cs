...
{
    /// <inheritdoc />
    public partial class CreateTableParametrosSondagem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "parametro_sondagem",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_parametro_sondagem", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_parametro_sondagem_ativo",
                table: "parametro_sondagem",
                column: "ativo");

            migrationBuilder.CreateIndex(
                name: "ix_parametro_sondagem_tipo",
                table: "parametro_sondagem",
                column: "tipo");

            migrationBuilder.CreateIndex(
                name: "ix_parametro_sondagem_tipo_ativo",
                table: "parametro_sondagem",
