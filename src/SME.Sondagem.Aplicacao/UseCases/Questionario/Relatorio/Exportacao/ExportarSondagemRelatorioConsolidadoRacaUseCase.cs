...
public class ExportarSondagemRelatorioConsolidadoRacaUseCase : IExportarSondagemRelatorioConsolidadoRacaUseCase
{
    ...
    public ExportarSondagemRelatorioConsolidadoRacaUseCase(ISolicitacaoRelatorioService solicitacaoRelatorioService, IServicoLog servicoLog, IServicoMensageria servicoMensageria, IServicoUsuario servicoUsuario)
    {
    ...
    private async Task<(bool, long)> RelatorioJaSolicitado(FiltroSolicitacaoRelatorioIntegracaoSgpDto filtro, CancellationToken ct)
    {
        ...
        {
            _servicoLog.Registrar($"ExportarSondagemRelatorioConsolidadoRacaUseCase - Falha ao controlar duplicidade de relatório: {filtro.TipoRelatorio}", ex);
        }
